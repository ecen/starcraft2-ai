...
#def __init__(self):
    ...
    if (os.path.isfile("./model.hdf5")):
       ...
       model = tf.keras.Sequential([
           tf.keras.layers.Flatten(), #64x64 res. 3=rgb
...
# Test network on test data
    ...
    def step(self, obs):
        ...
        result = self.model.predict(np.array(obs.observation['feature_screen'], dtype=np.float32)) ##Probably wrong since you get an array of results. 
